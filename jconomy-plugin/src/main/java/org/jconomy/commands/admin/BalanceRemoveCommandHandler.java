...
public class BalanceRemoveCommandHandler implements CommandHandler {

    private final BalanceAccess balanceAccess;
    private final EconomyConfig economyConfig;
    private final PlayerResolver playerResolver;

    public BalanceRemoveCommandHandler(
    ...
    public void execute(CommandContext<CommandSender> context) {
        ...
        sender.sendMessage("Removed " + amount.toPlainString() + " " + currency
                + " from " + playerName + " (new balance: " + balance.getAmount().toPlainString() + ")");
    }
}
