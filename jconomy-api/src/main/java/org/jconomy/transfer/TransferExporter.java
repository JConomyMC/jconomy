...
public interface TransferExporter {
     ...
     * {@code /jconomy export} commands. It must be unique among all registered
     * exporters and must not contain spaces.
     * </p>
     */
    String getName();
     ...
     * @return a snapshot of what this exporter would write
     */
    TransferPlan createPlan(ConflictPolicy policy);

    /**
     * Executes the export operation described by the given plan.
     * <p>
